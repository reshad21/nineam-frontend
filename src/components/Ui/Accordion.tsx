        ...
        >
          ...
          <div className="collapse-content">
            <p>
              ...
              preferences. Whether you're looking for a high-performance sports
              bike or a comfortable city cruiser, we have options for every type
              of rider. All our bikes are well-maintained and regularly serviced
              to ensure a smooth and safe ride.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="collapse-content">
            <p>
              ...
              opportunity to enjoy riding a bike without breaking the bank. With
              flexible rental packages, you can choose the one that best fits
        ...
        >
          ...
          <div className="collapse-content">
            <p>
              ...
              way. From helping you choose the right bike to providing roadside
              assistance, we prioritize your satisfaction. We’re always
              available to answer any questions or concerns, ensuring a pleasant
              and enjoyable rental experience.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="collapse-content">
            <p>
              ...
              inspected and serviced to meet safety standards, ensuring a
              reliable and secure ride for our customers. Your safety is our top
              concern.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="collapse-content">
            <p>
              ...
              friendly. By choosing to rent from us, you're helping reduce your
              carbon footprint. Biking is a sustainable mode of transport that
              promotes clean air and a healthier environment, and we're proud to
